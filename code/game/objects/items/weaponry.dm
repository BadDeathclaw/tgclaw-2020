...
/* none of these have icons yet and need to have their icon directory defined if we're using the seperate fallout spritesheet
...
/obj/item/claymore/machete/pipe/pan
	...
	icon_state = "pan"
	item_state = "pan"
	hitsound = 'sound/f13weapons/pan.ogg' //this isn't currently in the files either
	slot_flags = ITEM_SLOT_BELT //added ITEM_
